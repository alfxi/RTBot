...
def start(message):
    ...
    bot.send_message(message.chat.id, text="Привет! Это бот для организации обратной связи с абонентом.\nЕсли у тебя есть какие-либо вопросы или проблемы для начала проверь <b>❓ F.A.Q.</b>. \nЕсли на ваши вопросы ответов не нашлось - нажми на кнопку <b>☎️ Связаться с поддержкой</b> и наши сотрудники в скором времени Вам ответят!", parse_mode='html', reply_markup=markup.markup_main())
...
def send_text(message):
    ...
    if message.text == '✏️ Написать запрос':
        ...
        bot.send_message(message.chat.id, text="Частые вопросы:", reply_markup=markup.markup_faq())

    elif message.text == '☎️ Связаться с поддержкой':
        bot.send_message(message.chat.id, text="Выберете из меню.", parse_mode='html', reply_markup=markup.markup_help())
        ...
        if value == 0:
            bot.send_message(message.chat.id, 'У вас пока ещё нет запросов.', reply_markup=markup.markup_help())
        else:
...
def get_password_message(message):
    ...
    if password == None:
        ...
        bot.send_message(message.chat.id, 'Отменено.', reply_markup=markup.markup_help())
        return
        ...
        bot.send_message(message.chat.id, '🔑 Вы авторизованы как Агент поддержки', parse_mode='html', reply_markup=markup.markup_help())
...
def get_agent_id_message(message):
    ...
    if agent_id == None:
        ...
        bot.send_message(message.chat.id, '✅ Агент успешно добавлен.', reply_markup=markup.markup_help())
...
def get_new_request(message):
    ...
    if check_file != None:
        ...
        if str(request) == 'None':
            ...
            bot.send_message(message.chat.id, f'✅ Ваш запрос под ID {req_id} создан. Посмотреть текущие запросы можно нажав кнопку <b>Мои текущие запросы</b>', parse_mode='html', reply_markup=markup.markup_help())        
...
def get_additional_message(message, req_id, status):
    ...
    if additional_message == None:
        ...
        bot.send_message(message.chat.id, text, reply_markup=markup.markup_help())
        ...
        if status == 'agent':
            ...
            try:
                ...
                bot.send_message(user_id, f'⚠️ Получен новый ответ на ваш запрос ID {req_id}!\n\n🧑‍💻 Ответ агента поддержки:\n{additional_message}', reply_markup=markup.markup_help())

                if type == 'photo':
                    bot.send_photo(user_id, photo=file_id, reply_markup=markup.markup_help())
                elif type == 'document':
                    bot.send_document(user_id, data=file_id, reply_markup=markup.markup_help())
                elif type == 'video':
                    bot.send_video(user_id, data=file_id, reply_markup=markup.markup_help())
                elif type == 'audio':
                    bot.send_audio(user_id, audio=file_id, reply_markup=markup.markup_help())
                elif type == 'voice':
                    bot.send_voice(user_id, voice=file_id, reply_markup=markup.markup_help())
                else:
                    bot.send_message(user_id, additional_message, reply_markup=markup.markup_help())
            except:
                pass
...
def callback_inline(call):
    ...
    if call.message:
        ...
        if call.data == 'btnInternet':
            bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
                                text="Выбери интересующий тебя раздел:",
                                parse_mode='html', reply_markup=markup.markup_faq1())

        elif call.data == 'btnMobile':
            bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
                                text="Выбери интересующий тебя раздел:",
                                parse_mode='html', reply_markup=markup.markup_faq2())

        elif call.data == 'btnHomephone':
            bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
                                text="Выбери интересующий тебя раздел:",
                                parse_mode='html', reply_markup=markup.markup_faq3())


        elif call.data == 'btnTV':
            bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
                                text="Выбери интересующий тебя раздел:",
                                parse_mode='html', reply_markup=markup.markup_faq4())
        
        elif call.data == 'btnLK':
            bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
                                text="Выбери интересующий тебя раздел:",
                                parse_mode='html', reply_markup=markup.markup_faq5())

        elif call.data == 'bck':
            bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id,
                                text="Частые вопросы:",
                                parse_mode='html', reply_markup=markup.markup_faq())

        elif ('my_reqs:' in call.data) or ('waiting_reqs:' in call.data) or ('answered_reqs:' in call.data) or ('confirm_reqs:' in call.data):
            """
            ...
            if value == 0:
                bot.send_message(chat_id=call.message.chat.id, text='⚠️ Запросы не обнаружены.', reply_markup=markup.markup_help())
            ...
            try:
                ...
                bot.aend_message(chat_id=call.message.chat.id, text='Ваши запросы:', reply_markup=markup_req)
        ...
        #Открыть запрос
            ...
            for data in request_data:
                ...
                bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text=data, parse_mode='html', reply_markup=markup_req)
        ...
        #Завершить запрос
            ...
            if core.get_req_status(req_id) == 'confirm':
                bot.send_message(chat_id=call.message.chat.id, text="⚠️ Этот запрос уже завершен.", reply_markup=markup.markup_help())
                bot.answer_callback_query(call.id)
            ...
            #Подтвердить завершение
                ...
                try:
                    bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text="✅ Запрос успешно завершён.", reply_markup=markup.markup_help())
                except:
                    bot.send_message(chat_id=call.message.chat.id, text="✅ Запрос успешно завершён.", reply_markup=markup.markup_help())
        ...
        #Файлы запроса
            ...
            if value == 0:
                bot.send_message(chat_id=call.message.chat.id, text='⚠️ Файлы не обнаружены.', reply_markup=markup.markup_help())
                bot.answer_callback_query(call.id)
                return
        ...
        #Отправить файл
            ...
            if type == 'photo':
                bot.send_photo(call.message.chat.id, photo=file_id, reply_markup=markup.markup_help())
            elif type == 'document':
                bot.send_document(call.message.chat.id, data=file_id, reply_markup=markup.markup_help())
            elif type == 'video':
                bot.send_video(call.message.chat.id, data=file_id, reply_markup=markup.markup_help())
            elif type == 'audio':
                bot.send_audio(call.message.chat.id, audio=file_id, reply_markup=markup.markup_help())
            elif type == 'voice':
                bot.send_voice(call.message.chat.id, voice=file_id, reply_markup=markup.markup_help())
        ...
        #Все агенты
            ...
            if len_agents == 0:
                bot.send_message(chat_id=call.message.chat.id, text='⚠️ Агенты не обнаружены.', reply_markup=markup.markup_help())
                bot.answer_callback_query(call.id)
                return
        ...
        #Все пароли
            ...
            if len_passwords == 0:
                bot.send_message(chat_id=call.message.chat.id, text='⚠️ Пароли не обнаружены.', reply_markup=markup.markup_help())
                bot.answer_callback_query(call.id)
                return
